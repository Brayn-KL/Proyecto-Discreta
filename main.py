# dfa_cli_compacto.py — versión modificada
import sys, matplotlib.pyplot as plt, networkx as nx
from matplotlib.patches import FancyArrowPatch

# === Definición del DFA ===
states = {"q0", "q1", "q2", "q3", "q4", "q5", "q6"} # Ahora tiene 7 estados
alphabet = {"a", "b"}

# Se agregaron transiciones completas y bucles en q2, q5 y q6
delta = {
    ("q0", "a"): "q1", 
    ("q1", "a"): "q3", 
    ("q2", "a"): "q5",   
...
pos = nx.spring_layout(G, seed=42) # Semilla ajustada para 7 nodos

# === Dibujo por paso ===
def _mid(p1, p2, o=0.10):
    (x1, y1), (x2, y2) = p1, p2; mx, my = (x1+x2)/2, (y1+y2)/2; dx, dy = x2-x1, y2-y1; nx_, ny_ = -dy, dx; L = (nx_*2+ny_2)*0.5 or 1
